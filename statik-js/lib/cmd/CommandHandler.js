    ...
    switch (command) {
        case 'run':
            ...
            if (env === 'dev') {
                ...
                console.log('Unknown environment. Use "statik run dev" or "statik run prod".');
            }
            break;
        ...
        case 'version':
            ...
            console.log('StatikJS CLI: ' + packageInfo.version);
        ...
        case 'generate':
            ...
            if (capitalizedEnv === 'Component' || capitalizedEnv === 'Page') {
                ...
                console.log('Unknown environment. Use "statik generate component" or "statik generate page".');
            }
            break;

        default:
            console.log('Unknown command. Use "statik run", "statik build", or "statik generate".');
            break;
    }
};
